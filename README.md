## AWS CloudFormation Resource Provider Package For Amazon Kendra Intelligent Ranking

This repository contains AWS-owned resource providers for the `AWS::KendraRanking::ExecutionPlan` namespace.
